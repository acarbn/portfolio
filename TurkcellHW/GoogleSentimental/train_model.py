...
save_dir = "google_sentimentHW/data/"
...
model.save("google_sentimentHW/goSent_model_glove.h5")

import pickle
with open('google_sentimentHW/tokenizer_glove.pkl', 'wb') as f:
